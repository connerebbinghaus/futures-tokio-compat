...
impl<T> tokio::executor::Executor for Compat<T>
where
...
impl<T, Fut> tokio::executor::TypedExecutor<Fut> for Compat<T>
where
    T: futures_core::task::Spawn,
    Fut: core::future::Future<Output = ()> + Send + 'static,
{
    fn spawn(&mut self, future: Fut) -> Result<(), tokio::executor::SpawnError> {
        self.inner
